...
def main():
    ...
    print("Initial transaction count:", AUDIT_TRANSACTION_COUNT)
    ...
    owner, balance, transaction_history = acc["statement"]()

    print("Owner:", owner)
    print("Balance:", balance)
    print("History:", transaction_history)

    print("Transaction count:", AUDIT_TRANSACTION_COUNT)
